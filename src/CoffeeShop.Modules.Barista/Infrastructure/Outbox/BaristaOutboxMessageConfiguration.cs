...
internal sealed class BaristaOutboxMessageConfiguration
    : IEntityTypeConfiguration<BaristaOutboxMessage>
{
    public void Configure(EntityTypeBuilder<BaristaOutboxMessage> builder)
    {
