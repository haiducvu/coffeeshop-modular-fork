...
internal sealed class KitchenInboxMessageConfiguration
    : IEntityTypeConfiguration<KitchenInboxMessage>
{
    public void Configure(EntityTypeBuilder<KitchenInboxMessage> builder)
    {
