...
internal sealed class KitchenOutboxMessageConfiguration
    : IEntityTypeConfiguration<KitchenOutboxMessage>
{
    public void Configure(EntityTypeBuilder<KitchenOutboxMessage> builder)
    {
